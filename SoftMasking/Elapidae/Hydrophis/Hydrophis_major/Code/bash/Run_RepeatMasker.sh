...
species="Hydrophis_major"

# SET: Change this when needed
# Species name abreviation
species_abbreviation="hydMaj1"

# SET: Change this when needed
# Reference genome
reference_genome="$HOME/ExtraSSD2/Kaas/Projects/SquamateAlignments/Reference_Genomes/Public_Genomes/Elapidae/Hydrophis/Hydrophis_major/ncbi_dataset/data/GCA_033807585.1/GCA_033807585.1_HMAJ_1.0_genomic.fna"
