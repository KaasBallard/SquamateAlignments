...
species_abbreviation="najNaj1"

# SET: Change this when needed
# Reference genome
reference_genome="$HOME/ExtraSSD2/Kaas/Projects/SquamateAlignments/Reference_Genomes/Public_Genomes/Elapidae/Naja/Naja_naja/ncbi_dataset/data/GCA_009733165.1/GCA_009733165.1_Nana_v5_genomic.fna"
