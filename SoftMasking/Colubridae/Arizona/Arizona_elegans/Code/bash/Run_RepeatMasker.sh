...
species="Arizona_elegans"

# SET: Change this when needed
# Species name abreviation
species_abbreviation="ariEle1"

# SET: Change this when needed
# Reference genome
reference_genome="$HOME/ExtraSSD2/Kaas/Projects/SquamateAlignments/Reference_Genomes/Public_Genomes/Colubridae/Arizona/Arizona_elegans/ncbi_dataset/data/GCA_022577455.1/GCA_022577455.1_rAriEle1.0.p_genomic.fna"
