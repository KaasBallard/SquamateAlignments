...
species="Calamaria_suluensis"

# SET: Change this when needed
# Species name abreviation
species_abbreviation="calSul1"

# SET: Change this when needed
# Reference genome
reference_genome="$HOME/ExtraSSD2/Kaas/Projects/SquamateAlignments/Reference_Genomes/Public_Genomes/Colubridae/Calamaria/Calamaria_suluensis/ncbi_dataset/data/GCA_032468135.1/GCA_032468135.1_ASM3246813v1_genomic.fna"
