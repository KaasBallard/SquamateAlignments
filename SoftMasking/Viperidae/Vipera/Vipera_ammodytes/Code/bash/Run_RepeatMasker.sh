...
species="Vipera_ammodytes"

# SET: Change this when needed
# Species name abbreviation
species_abbreviation="vipAmm1"

# SET: Change this when needed
# Reference genome
reference_genome="$HOME/Documents/Kaas/SquamateAlignments/Reference_Genomes/Public_Genomes/Viperidae/Vipera/Vipera_ammodytes/ncbi_dataset/data/GCA_047301725.1/GCA_047301725.1_DTU_Vamm_2.0_genomic.fna"
