...
species="Crotalus_oreganus_helleri"

# SET: Change this when needed
# Species name abbreviation
species_abbreviation="croOreHel1"

# SET: Change this when needed
# Reference genome
reference_genome="$HOME/Documents/Kaas/SquamateAlignments/Reference_Genomes/Public_Genomes/Viperidae/Crotalus/Crotalus_oreganus_helleri/ncbi_dataset/data/GCA_024509115.1/GCA_024509115.1_rCroOre1.0.p_genomic.fna"

# NOTE: Change this when needed
# Set a directory for the genomic files create by this script
reference_genome_extra_dir="$HOME/Documents/Kaas/SquamateAlignments/Reference_Genomes/Public_Genomes/$family/$genus/$species/FromRepeatMaskerProcess"
...
repeat_masker_dir="$HOME/Documents/Kaas/SquamateAlignments/SoftMasking/$family/$genus/$species/Results/2_RepeatMasker"
