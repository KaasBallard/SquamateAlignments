...
species="Macrovipera_schweizeri"

# SET: Change this when needed
# Species name abbreviation
species_abbreviation="macSch1"

# SET: Change this when needed
# Reference genome
reference_genome="$HOME/Documents/Kaas/SquamateAlignments/Reference_Genomes/Public_Genomes/Viperidae/Macrovipera/Macrovipera_schweizeri/ncbi_dataset/data/GCA_965194845.1/GCA_965194845.1_rMacScw1.hap1.1_genomic.fna"
